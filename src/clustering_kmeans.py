...
from utils.parameters import IOParameters, KmeansParameters
...
if __name__ == "__main__":
    ...
    model_parameters = KmeansParameters(**parameters["model_parameters"])
    ...
    labels = run_kmeans(data, model_parameters.n_clusters)
