...
from utils.parameters import HDBSCANParameters, IOParameters
...
if __name__ == "__main__":
    ...
    model_parameters = HDBSCANParameters(**parameters["model_parameters"])
    ...
    labels = run_hdbscan(data, model_parameters.min_cluster_size)
